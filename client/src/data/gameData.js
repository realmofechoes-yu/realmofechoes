export const CLASS_INFO = {
  warrior: {
    ...
    skills: [
      { key: 'skill1', name: 'Cleave', description: '1.5× STR damage', cost: '15 SP', icon: '🗡️' },
      { key: 'skill2', name: 'Shield Bash', description: 'Stun enemy for 1 turn', cost: '20 SP', icon: '🛡️' }
    ],
  ...
  mage: {
    ...
    skills: [
      { key: 'skill1', name: 'Fireball', description: '2× INT damage', cost: '20 SP', icon: '🔥' },
      { key: 'skill2', name: 'Frost Nova', description: 'AoE damage + slow', cost: '25 SP', icon: '❄️' }
    ],
  ...
  ranger: {
    ...
    skills: [
      { key: 'skill1', name: 'Power Shot', description: '1.8× DEX damage', cost: '12 SP', icon: '🎯' },
      { key: 'skill2', name: 'Smoke Bomb', description: 'Dodge next attack', cost: '18 SP', icon: '💨' }
    ],
