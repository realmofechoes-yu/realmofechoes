          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="text-5xl mb-4 drop-shadow-lg flex items-center justify-center h-16">{(info.sprites?.idle || info.sprite) ? <img src={info.sprites?.idle || info.sprite} alt={info.name} className="w-16 h-16 object-contain drop-shadow-[0_0_5px_rgba(255,255,255,0.1)]" /> : info.icon}</div>
