              ...
              >
                ...
                <div className="flex justify-between items-start mb-6 relative z-10">
                  <div className="flex gap-4">
                    <div className="text-4xl drop-shadow-lg flex items-center justify-center w-12 h-12">{info?.sprite ? <img src={info?.sprite} alt={info?.name} className="w-12 h-12 object-contain drop-shadow-[0_0_5px_rgba(255,255,255,0.1)]" /> : <span style={{ color: info?.colorBright }}>{info?.icon}</span>}</div>
                    <div>
