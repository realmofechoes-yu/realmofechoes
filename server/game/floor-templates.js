...
const ENEMIES = {
  shadow_rat: { id: 'shadow_rat', name: 'Shadow Rat', sprites: { idle: '/sprites/shadow_rat/idle.gif', attack: '/sprites/shadow_rat/attack.gif', dead: '/sprites/shadow_rat/dead.gif' }, hp: 20, maxHp: 20, atk: 5, def: 2, spd: 8, xpReward: 15, goldReward: 5, special: { name: 'Quick Strike', description: 'Attacks twice for half damage each', type: 'double_attack', modifier: 0.5 }, flavorText: 'A skittering shadow with red, gleaming eyes.' },
  hollow_knight: { id: 'hollow_knight', name: 'Hollow Knight', sprites: { idle: '/sprites/hollow_knight/idle.gif', attack: '/sprites/hollow_knight/attack.gif', dead: '/sprites/hollow_knight/dead.gif' }, hp: 45, maxHp: 45, atk: 12, def: 10, spd: 4, xpReward: 30, goldReward: 12, special: { name: 'Shield Wall', description: '+50% DEF for 1 turn', type: 'buff_defense', modifier: 1.5, duration: 1 }, flavorText: 'An animated suit of ancient armor, empty within.' },
  flame_wraith: { id: 'flame_wraith', name: 'Flame Wraith', sprites: { idle: '/sprites/flame_wraith/idle.gif', attack: '/sprites/flame_wraith/attack.gif', dead: '/sprites/flame_wraith/dead.gif' }, hp: 35, maxHp: 35, atk: 15, def: 3, spd: 6, xpReward: 35, goldReward: 15, special: { name: 'Burn', description: 'Inflicts 3 damage per turn for 2 turns', type: 'dot', damage: 3, duration: 2 }, flavorText: 'A flickering spirit wreathed in ghostly flames.' },
  ...
  venom_crawler: { id: 'venom_crawler', name: 'Venom Crawler', sprites: { idle: '/sprites/venom_crawler/idle.gif', attack: '/sprites/venom_crawler/attack.gif', dead: '/sprites/venom_crawler/dead.gif' }, hp: 40, maxHp: 40, atk: 8, def: 6, spd: 5, xpReward: 28, goldReward: 11, special: { name: 'Poison', description: '4 damage per turn for 3 turns', type: 'dot', damage: 4, duration: 3 }, flavorText: 'A many-legged horror dripping with vile toxin.' },
  echoed_guardian: { id: 'echoed_guardian', name: 'Echoed Guardian', sprites: { idle: '/sprites/echoed_guardian/idle.gif', attack: '/sprites/echoed_guardian/attack.gif' }, hp: 60, maxHp: 60, atk: 14, def: 12, spd: 3, xpReward: 50, goldReward: 25, special: { name: 'Echo Drain', description: 'Steals 5 SP from the player', type: 'sp_drain', amount: 5 }, flavorText: 'A spectral warrior from a past life, bound to guard eternity.' }
};
