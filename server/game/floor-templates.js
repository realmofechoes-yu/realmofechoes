...
const ENEMIES = {
  ...
  hollow_knight: { id: 'hollow_knight', name: 'Hollow Knight', hp: 45, maxHp: 45, atk: 12, def: 10, spd: 4, xpReward: 30, goldReward: 12, special: { name: 'Shield Wall', description: '+50% DEF for 1 turn', type: 'buff_defense', modifier: 1.5, duration: 1 }, flavorText: 'An animated suit of ancient armor, empty within.' },
